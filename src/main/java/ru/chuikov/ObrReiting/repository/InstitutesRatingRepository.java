...
public interface InstitutesRatingRepository extends JpaRepository<InstitutesRating,InstitutionsRaitongKeys> {
    ...
    InstitutesRating findByUserAndInstitute(@Param("uname") User user,@Param("iname") Institute institute);
}
